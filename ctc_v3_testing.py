...
checkpoint_path = 'train_model_epoch_10.pt'
...
decoded_string = [decoded_string[i] if (decoded_string[i]!="$" or i==0) else decoded_string[i-1] for i in range(len(decoded_string)) ]
